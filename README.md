...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 0ca4d72b-5719-43c6-a9c8-88151a8361b7
```

> `0ca4d72b-5719-43c6-a9c8-88151a8361b7` is the password of the certificate, you can change it to any password you want.
...
https://abp.io/docs/latest/tutorials/book-store?UI=MVC&DB=EF